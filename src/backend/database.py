...
initial_announcements = [
    {
        "title": "Aviso da direção",
        "message": "As inscrições para as atividades extracurriculares seguem abertas nesta semana. Verifique os prazos e confirme sua participação enquanto houver vagas.",
        "start_date": None,
